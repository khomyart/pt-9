    ...
    <div class="container">
        ...
        <form class="auth_form" action="" method="<?=$form_method;?>">
            <div class="inputs_and_btns_holder">
                <input class="inputs <?=getFeedbackClass("login", "registration");?>" 
                       type="text" 
                       autocomplete="off" 
                       name="login" 
                       placeholder="Username">   
                <?=getFeedbackText("login", "registration");?>             
                <input class="inputs <?=getFeedbackClass("pwd", "registration");?>" 
                       type="text" 
                       autocomplete="off" 
                       name="pwd" 
                       placeholder="Password">
                <?=getFeedbackText("pwd", "registration");?>
                <input class="inputs <?=getFeedbackClass("display_name", "registration");?>" 
                       type="text" 
                       autocomplete="off" 
                       name="display_name" 
                ...
                <div class="button_holder">
                    ...
                    <button class="button" type="submit" name="registration" 
                            value="registration">
                        REGISTRATION
                    </button>
                </div>
